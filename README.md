...
**Open student work area** is available near the top of both the announcement studio and private crew sign-up. It opens public, generic directions with the teacher navigation and schedule live region hidden. Kenny keeps control of the display and uses **Teacher: exit student work area** before returning to preparation. This is projection separation, not a student account or authenticated device lock.

The work area has three desks, each with manual Prepare, Make/Edit and Review steps:

- **Short iMovie video:** one camera, three planned shots and a 15-45-second result using the September 9-10 work window. Students pitch, film, trim/arrange in iMovie, check sound and readable text, then bring the full video to Kenny before exporting to his chosen location. The app does not edit or collect video.
...
**Private crew check-in** records three teacher-entered confirmations for Announcer 1 and Announcer 2: the student says they checked in with their homeroom teacher before coming to CIRC, they have arrived, and they are ready with the rehearsed script. These are student affirmations, not verified school attendance. There are no student-name fields or notifications. Students tell Kenny about delays through the usual school-approved route. The teacher preparation screen must not be projected.

Recommended times are crew arrival by 8:50, Kenny's backup decision at 8:52, final microphone/script check at 8:54, and broadcast at 8:55. The teacher can edit these times. They never trigger an automatic replacement, absence record, message or clock-based lock. At the backup decision, Kenny can use a rehearsed backup or arrange coverage while accounting for bus and teacher delays. A covering student must still be homeroom-checked, present and ready; a teacher may also cover. Selecting or deselecting backup clears that role's earlier confirmations.
