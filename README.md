...
All five lessons preserve other crews' work and keep students away from uncured resin. The cardboard build adds a teacher-managed hot-glue station, with tape and tabs as its complete fallback. Epoxy remains required for the final build, with later teacher-managed product selection, compatibility checks, application and cure instructions. A heat gun is optional adult equipment only if the exact product instructions and school procedure allow it; no flame is used in the resin unit. The app does not infer that supplies have arrived or approve permanent attachment. The lesson labels are manual choices, not automatic school-rotation or calendar assignments.
